...
exports.MatchmakingModule = MatchmakingModule = __decorate([
    (0, common_1.Module)({
        imports: [parties_module_1.PartiesModule, users_module_1.UsersModule, auth_module_1.AuthModule],
        providers: [matchmaking_gateway_1.MatchmakingGateway, matchmaking_service_1.MatchmakingService],
    })
], MatchmakingModule);
