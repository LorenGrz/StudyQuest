    ...
    <MobileLayout>
      <div className="dashboard-page">
        ...
        {isTournamentsLoading ? (
          ...
          <div className="empty-state" style={{ padding: '16px', textAlign: 'center', background: 'var(--bg-surface)', borderRadius: '16px', border: '1px solid var(--overlay-subtle)' }}>
            <p className="empty-sub" style={{ margin: 0, fontSize: '11px', color: 'var(--text-secondary)' }}>No hay torneos activos en este momento.</p>
          </div>
        ) : (
