      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-black text-primary truncate max-w-[200px]">{tournament.title}</h1>
          ...
          <div className="bg-red-500/10 border border-red-500/25 px-3 py-1.5 rounded-2xl flex flex-col items-center shrink-0">
            ...
            <Countdown targetDate={tournament.endsAt} format="ms" className="text-xl text-red-500 tracking-wider" onComplete={() => navigate(`/tournament/${id}/results`)} />
          </div>
        </div>
        ...
        {isMyPartyParticipating ? (
          <div className="bg-gradient-to-br from-purple-950/20 to-indigo-950/20 border border-purple-500/30 p-4 rounded-3xl flex flex-col gap-3 relative overflow-hidden shrink-0">
            <div className="flex justify-between items-start">
              <div>
                <h4 className="text-primary font-extrabold text-sm">¡Tu Party está compitiendo!</h4>
        ...
        <div className="flex-1 flex flex-col gap-3 min-h-0 bg-surface border border-[var(--overlay-border)] rounded-3xl p-4">
                  ...
                  <div
                    ...
                    className={`flex items-center gap-3 p-3 rounded-2xl transition-all duration-300 border ${
                      isMyEntry
                        ...
                        : 'bg-elevated/50 border-[var(--overlay-border)] hover:bg-elevated'
                    }`}
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className={`text-xs font-bold truncate ${isMyEntry ? 'text-purple-400' : 'text-primary'}`}>
                        {entry.partyName}
                      </p>
                    ...
                    <div className="text-right shrink-0">
                      <span className="text-sm font-black text-primary">{entry.score} pts</span>
                    </div>
                  </div>
                )
              })
